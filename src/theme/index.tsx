...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    //primary colors
    primary1: darkMode ? '#0028FF' : '#0028FF',
    primary2: darkMode ? '#FFE08C' : '#FFE08C',
    primary3: darkMode ? '#F2CB61' : '#F2CB61',
    primary4: darkMode ? '#FFE08C' : '#FFE08C',
    primary5: darkMode ? '#03acff42' : '#03acff42',

    // color text
    primaryText1: darkMode ? '#0028FF' : '#0028FF',

    // secondary colors
    secondary1: darkMode ? '#0028FF' : '#0028FF',
    secondary2: darkMode ? '#FFE08C' : '#FFE08C',
    secondary3: darkMode ? '#03acff42' : '#03acff42',
